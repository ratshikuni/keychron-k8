...
4. You should be able to compile now
...
5. Put your K8 into DFU/bootloader mode:
    - Remove the spacebar and short the `BOOT` pin to `P9` pin
    - Note: There are 5 pins on the left of the spacebar switch, `BOOT` and `P9` are the two rightmost pins
